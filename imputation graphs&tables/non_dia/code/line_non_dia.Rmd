...
fb_non_dia = data.frame(frac_bias_approx, frac_bias_spline_zoo, frac_bias_linear, frac_bias_spline_imputeTS, frac_bias_stine, frac_bias_kalman, frac_bias_locf)

#setwd("/Users/yuxiding/Desktop").
#write.xlsx(fb_non_dia, file = "fb_non_dia.xlsx", sheetName = "fb_non_dia", col.names = TRUE, row.names = TRUE, append = FALSE)
...
```{r}
l=c('5','10','20','25','50','100')
plot(NULL,NULL, xaxt='n', xlim = c(1,8), ylim = c(0.8,1.2),xlab = 'Gap Size', ylab = 'Fractional Bias', main = 'Comparing Fractional Bias')
axis(1,at=seq(1:6),labels = l)
legend("topleft", c('zoo:na.approx', 'zoo:na.spline', 'imputeTS:na_interpolate_linear', 'imputeTS:na_interpolate_spline', 'imputeTS:na_interpolate_stine', 'imputeTS:na_kalman', 'imputeTS:na_locf'), col = c('red','blue','green','purple', 'yellow', 'orange', 'black'),lwd=2,cex=.75)
...
ioa_non_dia = data.frame(ioa_approx, ioa_spline_zoo, ioa_linear, ioa_spline_imputeTS, ioa_stine, ioa_kalman, ioa_locf)
#setwd("/Users/yuxiding/Desktop")
#write.xlsx(ioa_non_dia, file = "ioa_non_dia.xlsx", sheetName = "ioa_non_dia", col.names = TRUE, row.names = TRUE, append = FALSE)
...
```{r}
l=c('5','10','20','25','50','100')
plot(NULL,NULL, xaxt='n', xlim = c(1,8), ylim = c(0,12),xlab = 'Gap Size', ylab = 'Fractional Bias', main = 'Comparing Fractional Bias')
axis(1,at=seq(1:6),labels = l)
legend("topleft", c('zoo:na.approx', 'zoo:na.spline', 'imputeTS:na_interpolate_linear', 'imputeTS:na_interpolate_spline', 'imputeTS:na_interpolate_stine', 'imputeTS:na_kalman', 'imputeTS:na_locf'), col = c('red','blue','green','purple', 'yellow', 'orange', 'black'),lwd=2,cex=.75)
...
rmse_non_dia = data.frame(rmse_approx, rmse_spline_zoo, rmse_linear, rmse_spline_imputeTS, rmse_stine, rmse_kalman, rmse_locf)
#setwd("/Users/yuxiding/Desktop")
#write.xlsx(rmse_non_dia, file = "rmse_non_dia.xlsx", sheetName = "rmse_non_dia", col.names = TRUE, row.names = TRUE, append = FALSE)
...
```{r}
l=c('5','10','20','25','50','100')
plot(NULL,NULL, xaxt='n', xlim = c(1,8), ylim = c(11,15),xlab = 'Gap Size', ylab = 'Fractional Bias', main = 'Comparing Fractional Bias')
axis(1,at=seq(1:6),labels = l)
legend("topleft", c('zoo:na.approx', 'zoo:na.spline', 'imputeTS:na_interpolate_linear', 'imputeTS:na_interpolate_spline', 'imputeTS:na_interpolate_stine', 'imputeTS:na_kalman', 'imputeTS:na_locf'), col = c('red','blue','green','purple', 'yellow', 'orange', 'black'),lwd=2,cex=.75)
...
mad_non_dia = data.frame(mad_approx, mad_spline_zoo, mad_linear, mad_spline_imputeTS, mad_stine, mad_kalman, mad_locf)
mad_non_dia
#setwd("/Users/yuxiding/Desktop")
#write.xlsx(mad_non_dia, file = "mad_non_dia.xlsx", sheetName = "mad_non_dia", col.names = TRUE, row.names = TRUE, append = FALSE)
...
```{r}
imputable = data.frame(fb_non_dia,ioa_non_dia, rmse_non_dia, mad_non_dia)
imputable
#setwd("/Users/yuxiding/Desktop")
#write.xlsx(imputable, file = "imputable_non_dia.xlsx", sheetName = "rmse_non_dia", col.names = TRUE, row.names = TRUE, append = FALSE)
```
